...
const FIXED_API_URL: string = "https://script.google.com/macros/s/AKfycby2n8IEWMdV-Dywqky019S_1QcXwd1EEEidOgJCYiTYAryozSYgkt7eVhxEg7Fu6s0Ksw/exec"; // <<<< COLE SUA URL DENTRO DAS ASPAS AQUI
// ------------------------------------------------------------------
